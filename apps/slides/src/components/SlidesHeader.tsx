...
export const SlidesHeader = ({
  ...
  const { t, locale, setLocale } = useTranslation('slides');
      ...
      <header className="top-header flex h-14 items-center justify-between border-b border-border bg-background px-4 py-2">
            ...
            <TooltipTrigger
              render={
                <Link
                  ...
                  style={{ backgroundColor: 'var(--o-kind-slides)' }}
          ...
          <div className="flex min-w-0 flex-1 flex-col justify-center">
            <div className="flex items-center gap-1.5">
              ...
              <Tooltip>
                <TooltipTrigger
                  render={
                    <span className="inline-flex shrink-0 items-center gap-1 text-xs text-muted-foreground pl-1">
                      <Icon
                        name="cloud"
                        className={cn(
                          'size-3.5',
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          >
            ...
            <span className="hidden sm:inline">{t('openPptx')}</span>
          </Button>
          ...
          >
            ...
            <span>{exporting ? t('exporting') : t('exportPptx')}</span>
          </Button>

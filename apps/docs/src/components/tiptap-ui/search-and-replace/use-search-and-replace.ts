 ...
 */
export function getFindAndReplaceStorage(editor: Editor | null): FindAndReplaceStorage | null {
...
function navigateSearchResult({ editor, direction }: NavigateSearchResultOptions): boolean {
